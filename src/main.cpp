...
const string strMessageMagic = "BorzoCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 1000000000000 * COIN;	// 1000 billion coins, that all pow coins
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BorzoCoin
    bool fStrictPayToScriptHash = true; // Always active in BorzoCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BorzoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Agosto 10, 2014, Gaza, razzi e raid senza fine. Usa, Francia, Gb e Germania chiedono tregua.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1407627290;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13566531;
        ...
        assert(block.hashMerkleRoot == uint256("0x5443c87e6756562f0252721d6f48a640a66186f91a9467b9411bb00185b386af"));
